<div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
    <h1 class="text-4xl font-bold text-zinc-200">My Orders</h1>
    <div class="flex flex-col p-5 mt-4 rounded shadow-lg bg-zinc-900">
          ...
          <div class="overflow-hidden">
            <table class="min-w-full divide-y divide-gray-200 dark:divide-zinc-700">
              ...
              <tbody>
                ...
                @endphp
                <tr class="odd:bg-white even:bg-gray-100 dark:odd:bg-zinc-900 dark:even:bg-zinc-800 wire:key='{{ $order->id }}'">
                  ...
                  <td class="px-6 py-4 text-sm text-gray-800 whitespace-nowrap dark:text-gray-200">{{Number::currency($order->grand_total,'NPR')}}</td>
                  <td class="px-6 py-4 text-sm font-medium whitespace-nowrap text-end">
                    <a href="/my-orders/{{$order->id}}" class="px-4 py-2 text-white rounded-md bg-zinc-600 hover:bg-zinc-500">View Details</a>
                  </td>
                </tr>
